...
const {registerFaculty, registerStudent, createBatch, getbatchDetails, updateBatch,deleteBatch,deleteUser, getBatches, getFaculty} = require('../controllers/admin')
...
// get all batches
router.get('/batch',auth,getBatches);

// get faculty accounts
router.get('/faculty',auth,getFaculty);
